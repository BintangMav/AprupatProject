...
<div class="authentication-wrapper authentication-cover authentication-bg">
  <div class="authentication-inner row">
    <!-- /Left Text -->
    <div class="d-none d-lg-flex col-lg-7 p-10 justify-content-right">
      <div class="d-flex justify-content-center align-items-center ">
        <img src="../1.png" alt="" class="w-75 shadow-lg rounded">
      </div>
    </div>
    <!-- /Left Text -->
    ...
    <div class="d-flex col-12 col-lg-5 align-items-center p-sm-5 p-4">
      ...
      <img src="../logoLogin.png" alt="" width="450px" style="z-index: -1; padding-right:50px;">
        <form id="formAuthentication" class="mb-3" action="{{route('loginPegawai.login')}}" method="POST">
          @csrf
          <div class="mb-3">
