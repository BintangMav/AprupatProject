    ...
    <div class="modal-body">
        <div class="row mb-3">
            <div class="col mb-0">
                ...
                <input name="nik" type="name" class="form-control  @error('nik') is-invalid @enderror"
            ...
            <div class="col mb-0">
                ...
                <input name="nama" type="name" class="form-control @error('nama') is-invalid @enderror"
        ...
        <div class="row mb-3">
            <div class="col mb-0">
                ...
                <input name="no_telp" type="name" class="form-control @error('no_telp') is-invalid @enderror"
                    placeholder="Masukan No. Telpon"value="{{ $user->no_telp }}">
                @error('no_telp')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="row">
            <div class="col mb-3">
                ...
                <select id="selectpickerBasic" name="jenis_kelamin"
                    class="selectpicker w-100 @error('jenis_kelamin') is-invalid @enderror" data-style="btn-default">
            ...
            <div class="col mb-3">
                ...
                <select id="selectpickerBasic" name="status_jabatan"
                    class="selectpicker w-100 @error('status_jabatan') is-invalid @enderror" data-style="btn-default">
            ...
            <div class="col mb-3">
                ...
                <select id="selectpickerBasic" name="id_jabatan"
                    class="selectpicker w-100 @error('id_jabatan') is-invalid @enderror" data-style="btn-default">
            ...
            <div>
                ...
                <textarea class="form-control @error('alamat') is-invalid @enderror" name="alamat" id="exampleFormControlTextarea1"
                    rows="3" placeholder="Masukan Alamat..." value="{{ $user->alamat }}"></textarea>
                @error('alamat')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
