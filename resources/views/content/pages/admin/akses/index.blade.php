            ...
            <div class="col">
                <div class="card">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h3 role="button" class="text-hover-warning mb-0">Data Admin</h2>
            ...
            <div class="modal-content ">
                ...
                <form action="{{ route('admin.add') }}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="row mb-3">
                            <div class="col mb-0">
                              <label for="selectpickerBasic" class="form-label">Nama</label>
                              <select id="selectpickerBasic" name="id_pegawai" class="selectpicker w-100" data-style="btn-default">
                            ...
                            <div class="col mb-0">
                                ...
                                <input name="username" type="name" class="form-control" placeholder="Masukan username admin...">
                            </div>
                            <div class="col mb-0">
                                <label class="form-label">Password</label>
                                <input name="password" type="password" class="form-control" placeholder="Masukan password admin...">
                            </div>
                        </div>
                    </div>
